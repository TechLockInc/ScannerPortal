        ...
        <div class="row">
            ...
            <form action="/add_appliance" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="hostname" name="hostname" style="text-transform:uppercase;" laceholder="Appliance's Hostname" value="<?php echo e(old('hostname')); ?>">
                </div>
